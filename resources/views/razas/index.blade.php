...
@endif
    <div class="card-header">
        <a href="{{ route('razas.create') }}" class="btn btn-primary">Registro</a>
    </div>
    <div class="card">
        <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr> 
                        ...
                        <td>
                            ...
                            <form action="{{ route('razas.destroy', $razas) }}" method="POST">
                                <a href="{{ route('razas.edit',$razas) }}" class="btn btn-primary">Editar</a>
                                @method('delete')
                                @csrf
